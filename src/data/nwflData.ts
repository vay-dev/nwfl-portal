...
export const FEATURES = [
  ...
  },
  {
    ...
    completedAt: '2025-06-16',
    timeSpentHours: null,
    notes: 'Editable standings table with Group A/B coloring, inline number inputs, derived GD, and batch Save. Season selector loads distinct standing seasons from /api/standings/seasons/ and filters via ?season=.',
    files: [
